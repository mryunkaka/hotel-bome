...
class BankLedgersExport implements
    FromQuery,
    WithMapping,
    WithHeadings,
    WithEvents,
    ...
    WithColumnFormatting
{
    ...
    {
        // urutan sesuai importer
        return ['bank', 'deposit', 'withdraw', 'date', 'description'];
    }
    ...
    {
        return [
            'B' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED2, // deposit
            'C' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED2, // withdraw
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle($headerRange)->getFill()
                    ...
                    ->getStartColor()->setRGB('1F2937'); // abu gelap

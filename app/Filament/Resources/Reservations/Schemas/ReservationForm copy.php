...
class ReservationForm
{
    ...
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema->components([
            // ===========================
            // Reservation Info (selaras New Reservation otomatis)
            // ===========================
                ...
                ->schema([
                    Grid::make(12)->schema([
                        ...
                        TextInput::make('deposit')
                            ...
                            ->numeric()->default(0)->columnSpan(3)
            ...
            // ===========================
            // Information ringkasan (readonly mirror)
            // ===========================
                    ...
                    Grid::make(12)->schema([
                        TextInput::make('reservation_no_view')
                            ...
                            ->afterStateHydrated(function (Set $set, Get $get) {
                                $no = $get('reservation_no')
                                    ?? Reservation::generateReservationNo((int)(Session::get('active_hotel_id') ?? 0) ?: null);
                        ...
                        TextInput::make('created_by_view')
                            ...
                            ->afterStateHydrated(function (Set $set, Get $get) {
                                $uid  = $get('created_by');
                                $name = optional(User::find($uid))->name ?? Auth::user()?->name;
